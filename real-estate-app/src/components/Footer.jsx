    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section footer-brand-section">
          <div className="footer-brand">
            <LogoAnimated variant="light" />
          </div>
          <p className="footer-description">
            Your trusted partner in finding the perfect property. We connect buyers with premium residential, commercial, and agricultural land opportunities across India.
          </p>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><button type="button" onClick={() => handleNavigation('/listings')}>Properties</button></li>
            <li><button type="button" onClick={() => handleNavigation('/about')}>About Us</button></li>
            <li><button type="button" onClick={() => handleNavigation('/contact')}>Contact</button></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-links">
          <button type="button" onClick={() => handleNavigation('/about')}>Privacy Policy</button>
          <button type="button" onClick={() => handleNavigation('/about')}>Terms of Service</button>
